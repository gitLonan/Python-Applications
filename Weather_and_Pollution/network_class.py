...
class Network_communication:
    ...
    def get_current_weather_data(latitude: float, longitude: float, user):
        ...
        if response:
            result = json.loads(response)
            #print(json.dumps(result, indent=2))                    
            with open(r"C:/SVEE/Programi/Python skripte/Github - repositories/Python-Applications/Weather_and_Pollution/all the json files/Current Weather.json", "w") as f:
    ...
    def get_forecast_weatherFor_5days_data(latitude: float, longitude: float, user):
        ...
        if response:
            result = json.loads(response)
            #print(json.dumps(result, indent=2))                    
            with open(r"C:/SVEE/Programi/Python skripte/Github - repositories/Python-Applications/Weather_and_Pollution/all the json files/Forecast_weather_3h_step_5days.json", "w") as f:
                json.dump(result, f, indent=2)
        return
    ...
    def get_current_pollution(latitude: float, longitude: float, user):
        ...
        if response:
            result = json.loads(response)
            #print(json.dumps(result, indent=2))                    
            with open(r"C:/SVEE/Programi/Python skripte/Github - repositories/Python-Applications/Weather_and_Pollution/all the json files/Current Pollution.json", "w") as f:
                json.dump(result, f, indent=2)
        return
    ...
    def get_forcast_air_polution(latitude: float, longitude: float, user):
        ...
        if response:
            result = json.loads(response)
            #print(json.dumps(result, indent=2))                    
            with open(r"C:/SVEE/Programi/Python skripte/Github - repositories/Python-Applications/Weather_and_Pollution/all the json files/Forecast Pollution.json", "w") as f:
                json.dump(result, f, indent=2)

        return

    def request_weather_icon(icon_id=None):
        filename = "C:/SVEE/Programi/Python skripte/Github - repositories/Python-Applications/Weather_and_Pollution/temp_image.png"
